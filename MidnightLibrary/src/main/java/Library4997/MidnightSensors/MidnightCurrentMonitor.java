...
import Library4997.MidnightMotors.MidnightMotor;

public class MidnightCurrentMonitor {
    LynxModule hubOne;
    LynxModule hubTwo;

    public MidnightCurrentMonitor(HardwareMap hardwareMap, String hubOneName, String hubTwoName) {
        hubOne = hardwareMap.get(LynxModule.class, hubOneName);
        hubTwo = hardwareMap.get(LynxModule.class, hubTwoName);
    }

    public MidnightCurrentMonitor(HardwareMap opMode) {
        this(opMode, "Expansion Hub 1", "Expansion Hub 2");
    }

    public double getMotorCurrent(MidnightMotor motor) {
