 ...
 */
public class MidnightVuforia implements MidnightHardware {
    ...
    public MidnightVuforia(String t1, String t2, String t3, String asset) {
        parameters.vuforiaLicenseKey = MidnightUtils.VUFORIA_KEY;
    ...
    public MidnightVuforia(String t1, String t2, String asset)  {
        parameters.vuforiaLicenseKey = MidnightUtils.VUFORIA_KEY;
        parameters.cameraDirection = VuforiaLocalizer.CameraDirection.BACK;
        this.vuforia = ClassFactory.createVuforiaLocalizer(parameters);
        targetOne = t1;
    ...
    public MidnightVuforia(String t1, String asset) {
        parameters.vuforiaLicenseKey = MidnightUtils.VUFORIA_KEY;
        parameters.cameraDirection = VuforiaLocalizer.CameraDirection.BACK;
        this.vuforia = ClassFactory.createVuforiaLocalizer(parameters);
        targetOne = t1;
