package Library17822.MidnightCV;
 ...
 */
public class MidnightCV {
    private OpenCvCamera phoneCamera;
    private OpenCvWebcam webcam;
    public MidnightCVDetector detector;
    private Cam cam;
    ...
    public MidnightCV(MidnightCVDetector detector, Cam cam, HardwareMap hwMap){
        this.cam = cam;
