package Library17822.MidnightCV.detectors.skystone;
...
import Library17822.MidnightCV.MidnightCVUtils;
import Library17822.MidnightCV.detectors.MidnightCVDetector;
import Library17822.MidnightCV.filters.LeviColorFilter;
import Library17822.MidnightCV.filters.MidnightCVColorFilter;
import Library17822.MidnightCV.scoring.MaxAreaScorer;
import Library17822.MidnightCV.scoring.PerfectAreaScorer;
import Library17822.MidnightCV.scoring.RatioScorer;


public class StoneDetector extends MidnightCVDetector {
    public MidnightCVUtils.AreaScoringMethod areaScoringMethod = MidnightCVUtils.AreaScoringMethod.MAX_AREA; // Setting to decide to use MaxAreaScorer or PerfectAreaScorer

    //Create the default filters and scorers
    public MidnightCVColorFilter filter = new LeviColorFilter(LeviColorFilter.ColorPreset.YELLOW, 70); //Default Yellow blackFilter
    ...
    public void useDefaults() {
        ...
        if(areaScoringMethod == MidnightCVUtils.AreaScoringMethod.MAX_AREA){
            addScorer(maxAreaScorer);
        }

        if (areaScoringMethod == MidnightCVUtils.AreaScoringMethod.PERFECT_AREA){
